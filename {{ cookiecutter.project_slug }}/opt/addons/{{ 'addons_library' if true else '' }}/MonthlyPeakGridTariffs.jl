...
#   the month number (1-12). If you use different names, don't forget to update the name in the add on code too
# - The add on is applied to a connection. Therefore, you create a node for the electricity grid, a and a node for your
#   'internal' electricity grid abd then make a connection between these two. 

# Comments
# This version for grid tariffs requires the creation fo additional components, but is more straightforward to 
